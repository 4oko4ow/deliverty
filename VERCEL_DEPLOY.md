...
## Шаг 6: Настройка Telegram Login Widget

После деплоя frontend на Vercel:

1. **Скопируйте ваш Vercel URL**:
   - После деплоя вы увидите URL (например, `deliverty-web.vercel.app`)
   - Или используйте кастомный домен, если настроили

2. **Настройте домен в BotFather**:
   - Откройте [@BotFather](https://t.me/BotFather) в Telegram
   - Отправьте `/setdomain`
   - Выберите вашего бота
   - Укажите ваш **Vercel URL** (например, `deliverty-web.vercel.app`)
   - ⚠️ **Важно**: Используйте frontend URL (Vercel), НЕ backend URL (Render)

3. **Проверьте настройки**:
   - Убедитесь, что `VITE_TG_BOT` в Vercel environment variables совпадает с именем бота
...
2. Откройте URL и проверьте:
   ...
   - Telegram Login Widget работает на странице `/auth`
