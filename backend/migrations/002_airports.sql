...
('GRZ','Grozny','Grozny','Russia','Europe/Moscow'),
...
('KUF','Kurumoch','Samara','Russia','Europe/Samara'),
('PEE','Perm','Perm','Russia','Asia/Yekaterinburg'),
('RTW','Saratov','Saratov','Russia','Europe/Samara'),
('VOG','Volgograd','Volgograd','Russia','Europe/Moscow'),
('VOZ','Voronezh','Voronezh','Russia','Europe/Moscow'),
('EGO','Belgorod','Belgorod','Russia','Europe/Moscow'),
('MMK','Murmansk','Murmansk','Russia','Europe/Moscow'),
('ARH','Talagi','Arkhangelsk','Russia','Europe/Moscow'),
('PKV','Pskov','Pskov','Russia','Europe/Moscow'),
('SCW','Syktyvkar','Syktyvkar','Russia','Europe/Moscow'),
('IWA','Ivanovo','Ivanovo','Russia','Europe/Moscow'),
('KLD','Tver','Tver','Russia','Europe/Moscow'),
('KLF','Kaluga','Kaluga','Russia','Europe/Moscow'),
('OSW','Orsk','Orsk','Russia','Asia/Yekaterinburg'),
('SGC','Surgut','Surgut','Russia','Asia/Yekaterinburg'),
('MQF','Magnitogorsk','Magnitogorsk','Russia','Asia/Yekaterinburg'),
('BZK','Bryansk','Bryansk','Russia','Europe/Moscow'),
('KMW','Kostroma','Kostroma','Russia','Europe/Moscow'),
('LPK','Lipetsk','Lipetsk','Russia','Europe/Moscow'),
('NBC','Naberezhnye Chelny','Naberezhnye Chelny','Russia','Europe/Samara'),
('RZN','Ryazan','Ryazan','Russia','Europe/Moscow'),
('TBW','Tambov','Tambov','Russia','Europe/Moscow'),
('TOF','Tomsk','Tomsk','Russia','Asia/Krasnoyarsk'),
('ULY','Ulyanovsk','Ulyanovsk','Russia','Europe/Samara'),
('YKS','Yakutsk','Yakutsk','Russia','Asia/Yakutsk'),
('MJZ','Mirny','Mirny','Russia','Asia/Yakutsk'),
('PKC','Yelizovo','Petropavlovsk-Kamchatsky','Russia','Asia/Kamchatka'),
-- Ukraine
...
('KZO','Kyzylorda','Kyzylorda','Kazakhstan','Asia/Qyzylorda'),
('TDK','Taldykorgan','Taldykorgan','Kazakhstan','Asia/Almaty'),
('DZN','Zhezkazgan','Zhezkazgan','Kazakhstan','Asia/Almaty'),
('KSN','Kostanay','Kostanay','Kazakhstan','Asia/Qostanay'),
('KVD','Taraz','Taraz','Kazakhstan','Asia/Almaty'),
-- Uzbekistan
...
('KAY','Kayseri','Kayseri','Turkey','Europe/Istanbul'),
('ASR','Erkilet','Kayseri','Turkey','Europe/Istanbul'),
('TZX','Trabzon','Trabzon','Turkey','Europe/Istanbul'),
('ADA','Adana','Adana','Turkey','Europe/Istanbul'),
('ESB','Esenboga','Ankara','Turkey','Europe/Istanbul'),
...
('RKT','Ras Al Khaimah','Ras Al Khaimah','United Arab Emirates','Asia/Dubai'),
('FJR','Fujairah','Fujairah','United Arab Emirates','Asia/Dubai'),
('DWC','Al Maktoum','Dubai','United Arab Emirates','Asia/Dubai'),
...
('HDY','Hat Yai','Hat Yai','Thailand','Asia/Bangkok'),
('UTH','Udon Thani','Udon Thani','Thailand','Asia/Bangkok'),
('BFV','Buriram','Buriram','Thailand','Asia/Bangkok'),
-- Vietnam
